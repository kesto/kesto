-file("/usr/local/Cellar/erlang/R15B03-1/lib/erlang/lib/parsetools-2.0.7/include/leexinc.hrl", 0).
...
-file("/usr/local/Cellar/erlang/R15B03-1/lib/erlang/lib/parsetools-2.0.7/include/leexinc.hrl", 14).
...
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 57 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 59 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 31 ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 33, C =< 57 ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 61, C =< 64 ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 91, C =< 96 ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 122 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 123 ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
...
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(24, Ics, Line, Tlen+1, 2, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 57 ->
    yystate(24, Ics, Line, Tlen+1, 2, Tlen);
...
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 57 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 59, C =< 64 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(16, Ics, Line, Tlen, _, _) ->
    {2,Tlen,Ics,Line,16};
yystate(15, [C|Ics], Line, Tlen, Action, Alen) when C >= 49, C =< 57 ->
...
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 57 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 59, C =< 64 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(10, Ics, Line, Tlen+1, 3, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 91, C =< 96 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(14, Ics, Line, Tlen, _, _) ->
    {3,Tlen,Ics,Line,14};
yystate(13, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 53 ->
...
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 57 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 59 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 47 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(8, Ics, Line, Tlen+1, 3, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 59, C =< 61 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 63 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 47 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 49, C =< 57 ->
    yystate(4, Ics, Line, Tlen+1, 3, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 59, C =< 61 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 48 ->
    yystate(24, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(24, Ics, Line, Tlen+1, 0, Tlen);
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 57 ->
    yystate(24, Ics, Line, Tlen+1, 0, Tlen);
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 59 ->
    yystate(24, Ics, Line, Tlen+1, 0, Tlen);
...
-file("src/syslog_lexer.xrl", 11).
yyaction_0(TokenChars) ->
     { token, { priority, priority (TokenChars) } } .

-compile({inline,yyaction_1/1}).
-file("src/syslog_lexer.xrl", 12).
yyaction_1(TokenChars) ->
     { token, { datetime, TokenChars } } .

-compile({inline,yyaction_2/0}).
-file("src/syslog_lexer.xrl", 14).
yyaction_2() ->
     skip_token .

-compile({inline,yyaction_3/1}).
-file("src/syslog_lexer.xrl", 15).
yyaction_3(TokenChars) ->
     { token, { word, TokenChars } } .

-compile({inline,yyaction_4/1}).
-file("src/syslog_lexer.xrl", 16).
yyaction_4(TokenChars) ->
     { token, { ':', TokenChars } } .

-file("/usr/local/Cellar/erlang/R15B03-1/lib/erlang/lib/parsetools-2.0.7/include/leexinc.hrl", 282).
